...
const PortfolioSection: React.FC = () => {
  return (
    <section className="flex flex-col justify-center p-32 bg-stone-50 max-md:px-5 max-md:py-24">
      <div className="flex flex-col w-full text-black max-md:max-w-full -ml-20">
        <header className="flex flex-wrap gap-10 justify-between items-center w-full max-md:max-w-full">
          <h2 className=" font-gilroy self-stretch my-auto text-4xl font-bold leading-10 w-[435px] max-md:max-w-full">
        ...
        <div className="flex flex-col md:flex-row md:gap-16 gap-4 items-center mt-8 w-full text-2xl font-bold leading-none max-md:max-w-full">
